...
// as parameter.   A fraction object returned receives product.
...
// as paramter.		A fraction object returned recieves quotient.
Rational Rational::Divide(Rational operand2)
{
	Rational newFract;
	newFract.numerator = numerator * operand2.denominator;
	newFract.denominator = denominator * operand2.numerator;
